...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    keywords: ["bamboo toothbrush", "eco-friendly toothbrush", "sustainable toothbrush", "plastic-free", "charcoal bristles"],
    alternates: {
      canonical: "https://ecofriendlyshop.us/product/bamboo-toothbrush-10-pack",
    },
    openGraph: {
      title,
      description,
...
export default async function ToothbrushLayout({
  children,
}: {
