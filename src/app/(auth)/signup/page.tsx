                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-2 text-sm outline-none border rounded-xl focus:ring-2 focus:ring-[#005655] focus:border-transparent transition-all duration-300 ${errors.name
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full pl-10 pr-12 py-2 text-sm outline-none border rounded-xl focus:ring-2 focus:ring-[#005655] focus:border-transparent transition-all duration-300 ${errors.confirmPassword
                                        ? "border-red-300 bg-red-50"
                                        : "border-gray-300"
                                        }`}
                        ...
                        <div className="flex items-center space-x-2">
                            <input
                                ...
                                className="h-4 w-4 rounded border-gray-300 text-[#005655] focus:ring-2 focus:ring-[#005655] focus:ring-offset-0"
                            />
                            <label
